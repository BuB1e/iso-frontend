...
export class UserService {
    ...
    public static async createUser(body: CreateUserDto): Promise<UserResponseDto | null> {
        try {
    ...
    public static async updateUserById(body: UpdateUserDto): Promise<UserResponseDto | null> {
        try {
