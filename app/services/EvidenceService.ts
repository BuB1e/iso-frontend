import type { createEvidenceDto, EvidenceResponseDto, updateEvidenceDto } from "~/dto";
...
export class EvidenceService {
    ...
    public static async createEvidence(body: createEvidenceDto): Promise<EvidenceResponseDto | null> {
        try {
    ...
    public static async getEvidenceById(id: number): Promise<EvidenceResponseDto | null> {
        try {
    ...
    public static async getAllEvidenceByControlId(controlId: number): Promise<EvidenceResponseDto[]> {
        try {
            const response = await axios.get(`${this.API_URL}/getAllByControlId/${controlId}`);
            const data: EvidenceResponseDto[] = await response.data;
            return data;
        } catch (error) {
            console.error("Error :", error);
    ...
    public static async updateEvidenceById(body: updateEvidenceDto): Promise<EvidenceResponseDto | null> {
        try {
