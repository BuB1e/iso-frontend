import type {
  CreateIsoAssessmentDto,
  UpdateIsoAssessmentDto,
...
export class IsoAssessmentService {
  ...
  public static async createIsoAssessment(
    body: CreateIsoAssessmentDto,
  ): Promise<IsoAssessmentResponseDto | null> {
    try {
  ...
  public static async getIsoAssessmentById(
    id: number,
  ): Promise<IsoAssessmentResponseDto | null> {
    try {
  ...
  public static async getAllIsoAssessment(): Promise<
    IsoAssessmentResponseDto[]
  > {
    try {
  ...
  public static async getIsoAssessmentByCompanyId(
    companyId: number,
  ): Promise<IsoAssessmentResponseDto | null> {
    try {
  ...
  public static async updateIsoAssessmentById(
    body: UpdateIsoAssessmentDto,
  ): Promise<IsoAssessmentResponseDto | null> {
    try {
