  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <Link
          to="/login"
          className="inline-flex items-center text-sm text-slate-600 hover:text-main-blue mb-4"
        >
          ← Back to Login
        </Link>
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className={`block w-full pl-10 sm:text-sm rounded-md p-2 border ${passwordError ? "border-red-500" : "border-slate-300"} focus:ring-main-blue focus:border-main-blue`}
                  minLength={8}
